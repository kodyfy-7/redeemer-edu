...
{{-- @if (auth()->user()->role->role_slug == 'admin')
  <a href="{{ route('results.index') }}" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
@else
<a href="{{ route('my.result.pdf', [$result->result_slug]) }}" class="btn btn-primary"><i class="glyphicon glyphicon-download-alt"></i></a>
@endif --}}
<a href="{{ route('my.result.pdf', [$result->result_slug]) }}" class="btn btn-primary"><i class="glyphicon glyphicon-download-alt"></i></a>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                <h2>Report card for {{ $year->session }}</h2>
                ...
                <table id="example1" class="table table-bordered table-striped table-responsive">
                  ...
                  {{-- <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                    <div class="row">
                        <div class="col-6">YUOUOU</div>
                        <div class="col-6">YUOUOUuhihishui</div>
                    </div>
                    <thead>
                      <tr>
                        <th>Name</th>

                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu">
                            <div class="user-header">
                                ...
                                <div class="user-text">
                                    <h6>{{ auth()->user()->username ?? 'Defualt Name' }}</h6>
                                    <p class="text-muted mb-0">
                                        @if (auth()->user()->role->role_slug == 'admin') 
                                            Administrator
                                        @elseif (auth()->user()->role->role_slug == 'guardian') 
                                            Parent
                                        @else 
                                            Student
                                        @endif
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            @if (auth()->user()->role->role_slug == 'admin')
                                ...
                                <li>
                                    <a href="{{ route('results.index') }}"><i class="fas fa-home"></i> <span>Result Upload</span></a>
                                </li>
                            @elseif(auth()->user()->role->role_slug == 'guardian')
                                <li>

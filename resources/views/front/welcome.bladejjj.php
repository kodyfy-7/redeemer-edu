...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('website/rs-plugin/css/settings.css') }}">
        <!-- Jquery Fancybox CSS -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website/css/jquery.fancybox.min.css') }}" media="screen" />
        <link href="{{ asset('website/css/animate.css') }}" rel="stylesheet">
        <link href="{{ asset('website/css/style.css') }}" rel="stylesheet"  id="colors">
    ...
    <body>
        ...
        <div class="header-wrap">
            <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-12 navbar-light">
                    <div class="logo"> <a href="/"><img alt="" class="logo-default" src="{{ asset('website/images/logo.png') }}"></a></div>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="#">Menu</a>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <ul class="submenu">
                                <li><a href="{{ asset('administrator/login') }}">Admininstrator</a></li>
                                <li><a href="{{ asset('parent/login') }}">Parent</a></li>
                                <li><a href="{{ asset('teacher/login') }}">Teacher</a></li>
                            </ul>
                            </li>
        ...
        <div class="tp-banner-container">
            <div class="tp-banner">
                <ul>
                <li data-slotamount="7" data-transition="3dcurtain-horizontal" data-masterspeed="1000" data-saveperformance="on"> <img alt="" src="{{ asset('website/images/dummy.png') }}" data-lazyload="{{ asset('website/images/slider1.jpg') }}">
                ...
                <li data-slotamount="7" data-transition="slotzoom-horizontal" data-masterspeed="1000" data-saveperformance="on"> <img alt="" src="{{ asset('website/images/dummy.png') }}" data-lazyload="{{ asset('website/images/slider.jpg') }}">
            ...
            <div class="container">
                ...
                <ul class="row unorderList">
                    ...
                    <div class="categories-course">
                        ...
                        <div class="cours-icon"> <span class="coure-icon-inner"> <img src="{{ asset('website/images/teacher.png') }}" alt=""> </span> </div>
                    ...
                    <div class="categories-course">
                        <div class="item-inner">
                        <div class="cours-icon"> <span class="coure-icon-inner"> <img src="{{ asset('website/images/book.png') }}" alt=""> </span> </div>
                        <div class="cours-title">
                    ...
                    <div class="categories-course" >
                        <div class="item-inner">
                        <div class="cours-icon"> <span class="coure-icon-inner"> <img src="{{ asset('website/images/support.png') }}" alt=""> </span> </div>
                        <div class="cours-title">
                            <h4>School Life</h4>
                    ...
                    <div class="categories-course">
                        <div class="item-inner">
                        <div class="cours-icon"> <span class="coure-icon-inner"> <img src="{{ asset('website/images/scholarship.png') }}" alt=""> </span> </div>
                        <div class="cours-title">
                            <h4>Leadership</h4>
        ...
        <div class="about-wrap  " id="about">
            <div class="container">
                <div class="row">
                <div class="col-lg-7">
                    <div class="aboutImg"><img src="{{ asset('website/images/aboutImg.png') }}" alt=""></div>
                </div>
                <div class="col-lg-5">
                    <div class="about_box">
                    <div class="title">
            ...
            <!--          <ul class="edu_list">
                        ...
                        <div class="learing-wrp">
                            <div class="edu_icon"><img src="{{ asset('website/images/education.png') }}" alt=""></div>
                            <div class="learn_info">
                        ...
                        <li>
                        <div class="learing-wrp">
                            <div class="edu_icon"><img src="{{ asset('website/images/class.png') }}" alt=""></div>
                            <div class="learn_info">
                        ...
                        <li>
                        <div class="learing-wrp">
                            <div class="edu_icon"><img src="{{ asset('website/images/academy.png') }}" alt=""></div>
                            <div class="learn_info">
        ...
        <div class="container">
            ...
            <li class="item">
                <div class="class_box">
                <div class="class_Img"><img src="{{ asset('website/images/education_img.jpg') }}" alt="">
            ...
            <li class="item">
                <div class="class_box">
                <div class="class_Img"><img src="{{ asset('website/images/kid_game.jpg') }}" alt="">
                    <div class="time_box"><span>08:00 am - 10:00 am</span></div>
                </div>
                <div class="path_box">
            ...
            <li class="item">
                <div class="class_box">
                <div class="class_Img"><img src="{{ asset('website/images/lab.jpg') }}" alt="">
                    <div class="time_box"><span>08:00 am - 10:00 am</span></div>
                </div>
                <div class="path_box">
        ...
        <div class="container">
            ...
            <div class="phonewrp"><img src="{{ asset('website/images/phone_icon.png') }}" alt=""><a href="#">08035132506</a></div>
        </div>
        </div>
        <!-- Enroll End -->
        ...
        <div class="container">
            <div class="row">
            <div class="col-lg-4">
                <div class="footer_logo"><img alt="" class="footer-default" src="{{ asset('website/images/logo2.png') }}"></div>
        ...
        <script src="{{ asset('website/js/extra.min.js') }}"></script>
        <script src="{{ asset('website/js/popper.min.js') }}"></script>
        <script src="{{ asset('website/rs-plugin/js/jquery.themepunch.tools.min.js') }}"></script>
        <script src="{{ asset('website/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>
        <!-- Jquery Fancybox -->
        <script src="{{ asset('website/js/jquery.fancybox.min.js') }}"></script>
        <!-- Animate js -->
        <script src="{{ asset('website/js/animate.js') }}"></script>
        <script>
        new WOW().init();
        </script>
        <!-- WOW file -->

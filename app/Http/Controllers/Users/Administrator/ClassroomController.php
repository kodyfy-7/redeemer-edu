...
class ClassroomController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('administrator.classroom.index', [
    ...
    public function show(Classroom $classroom)
    {
        ...
        return view('administrator.classroom.show', [
            'classroom' => $classroom,
            'students' => $students,
    ...
    public function edit(Classroom $classroom)
    {
        //$classroom = new Classroom;
        $categories = ClassroomCategory::get();
        return view('administrator.classroom.edit', [
            'classroom' => $classroom,
            'categories' => $categories
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('administrator.classrooms.index')->with('success', 'Data saved successfully.');  
    }
    ...
    public function updateTeacher(Request $request)
    {
        ...
        return redirect()->route('administrator.classrooms.show', $request->slug)->with('success', 'Data saved successfully.');
    }
}
